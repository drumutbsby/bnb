...
- **Rütbe, rekorlar & rozetler**: cihazda kalıcı profil, XP ile rütbe atlama, başarım
  rozetleri (İlk Zafer, Kusursuz, Hız Canavarı…), en iyi puan/seri
- **Global sıralama** (topluluk · en iyi çaba): cihazlar-arası tüm zamanların en iyileri
- **Hızlı Eşleş**: kod girmeden rastgele açık odaya katılma
- **Temalar** (Mor, Okyanus, Orman, Gün Batımı, Gece) ve ses ayarları
