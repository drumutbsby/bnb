// Soru shard: teknoloji — tembel yüklenir (js/questions.js).
export default [
  {
  ...
  {
    "q": "'Bit' ve 'byte' hangi alanla ilgilidir?",
    "options": [
      "Tıp",
      "Bilişim",
      "Müzik",
  ...
  {
    "q": "İnternette bir adresin başında sıkça görülen güvenli protokol hangisidir?",
    "options": [
      "FTP",
      "HTTPS",
      "SMTP",
  ...
  {
    "q": "Bir bilgisayarda CPU ile RAM arasında geçici veri saklayan çok hızlı bellek türü aşağıdakilerden hangisidir?",
    "options": [
      "Önbellek (Cache)",
      "Sabit disk",
      "ROM",
  ...
  {
    "q": "Aşağıdaki bağlantı noktalarından hangisi hem görüntü hem ses aktarabilir?",
    "options": [
      "HDMI",
      "VGA",
      "DVI-D",
  ...
  {
    "q": "Isaac Asimov'un Robotik Yasaları'na sonradan eklenen, diğer üçünün önüne geçen yasa hangisidir?",
    "options": [
      "Sıfırıncı Yasa",
      "Dördüncü Yasa",
      "Temel Yasa",
  ...
  {
    "q": "Plüton'un yakın görüntülerini 2015'te ileten uzay aracının adı nedir?",
    "options": [
      "New Horizons",
      "Dawn",
      "Pioneer 10",
  ...
  {
    "q": "TCP/IP modelinde 'HTTPS' varsayılan olarak hangi portu kullanır?",
    "options": [
      "443",
      "80",
      "8080",
  ...
  },
  {
    ...
    "options": [
      "Herkese okuma, yazma ve çalıştırma",
      "Yalnızca sahibe tam izin",
      "Yalnızca okuma",
      "Yazma yok, okuma ve çalıştırma"
    ],
    "answer": 0
  },
  {
