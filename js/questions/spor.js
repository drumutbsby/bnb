// Soru shard: spor — tembel yüklenir (js/questions.js).
export default [
  {
  ...
  {
    "q": "Türkiye Süper Lig'i ilk kez şampiyon olarak Anadolu'ya taşıyan kulüp hangisidir?",
    "options": [
      "Bursaspor",
      "Trabzonspor",
      "Kayserispor",
  ...
  {
    "q": "2002 Dünya Kupası'nda Türkiye Milli Takımı hangi dereceyi elde etti?",
    "options": [
      "Şampiyon",
      "İkinci",
      "Üçüncü",
  ...
  {
    "q": "Türkiye Erkek Milli Voleybol Takımı'nın lakabı nedir?",
    "options": [
      "Filenin Sultanları",
      "Filenin Efeleri",
      "Potanın Aslanları",
  ...
  {
    "q": "Türk kadın voleybol milli takımı 2023 yılında hangi büyük şampiyonluğu kazandı?",
    "options": [
      "Dünya Şampiyonluğu",
      "Avrupa Şampiyonluğu",
      "Olimpiyat altını",
  ...
  {
    "q": "Galatasaray 2000 yılında hangi Avrupa kupasını kazanarak Türk futbolunda ilki gerçekleştirdi?",
    "options": [
      "Şampiyonlar Ligi",
      "UEFA Kupası",
      "Süper Kupa",
