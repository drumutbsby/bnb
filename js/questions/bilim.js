// Soru shard: bilim — tembel yüklenir (js/questions.js).
export default [
  {
  ...
  {
    "q": "Besinlerin sindiriminde ve emiliminin büyük kısmının gerçekleştiği organ hangisidir?",
    "options": [
      "Mide",
      "İnce bağırsak",
      "Yemek borusu",
  ...
  },
  {
    ...
    "options": [
      "Ay, Güneş ile Dünya arasına girdiğinde",
      "Dünya, Ay ile Güneş arasına girdiğinde",
      "Güneş, Ay ile Dünya arasına girdiğinde",
  ...
  {
    "q": "Demirin havada oksijen ve nemle tepkimeye girerek paslanması hangi tür kimyasal olaydır?",
    "options": [
      "İndirgenme",
  ...
  {
    "q": "Kireç taşının (kalsiyum karbonat) kimyasal formülü hangisidir?",
    "options": [
      "CaCO3",
      "Ca(OH)2",
      "CaCl2",
