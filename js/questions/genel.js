// Soru shard: genel — tembel yüklenir (js/questions.js).
export default [
  {
  ...
  {
    "q": "2, 4, 8, 16, ... dizisinde bir sonraki sayı kaçtır?",
    "options": [
      "24",
      "32",
      "20",
  ...
  },
  {
    ...
    "options": [
      "Rengi bozar",
      "Erken eklenince baklagillerin geç pişmesine yol açabilir",
      "Zehir yapar",
      "Kokuyu keser"
    ],
    "answer": 1
  ...
  {
    "q": "Dünyanın en küçük bağımsız devleti hangisidir?",
    "options": [
      "Monako",
      "Nauru",
      "San Marino",
  ...
  },
  {
    ...
    "options": [
      "Metali (jilet gibi) zamanla aşındırabilir",
      "Sadece suyu",
      "Hiçbir şeyi",
      "Elması"
    ],
  ...
  },
  {
    ...
    "options": [
      "Ağaçta",
      "Yerde, tek bir bitkinin ortasında (toprakta çalı gibi)",
      "Su altında",
      "Sarmaşık olarak"
    ],
    "answer": 1
  ...
  {
    "q": "Nüfusu en kalabalık ülke unvanını 2023'te Çin'den devralan ülke hangisidir?",
    "options": [
      "Endonezya",
      "ABD",
      "Pakistan",
  ...
  {
    "q": "Yeryüzünün en kurak yerlerinden biri kabul edilen Atacama Çölü hangi ülkededir?",
    "options": [
      "Peru",
      "Şili",
      "Arjantin",
  ...
  {
    "q": "Ekonomide 'stagflasyon' terimi hangi iki olgunun bir arada görülmesini ifade eder?",
    "options": [
      "Yüksek enflasyon ve yüksek işsizlik/durgunluk",
      "Deflasyon ve tam istihdam",
      "Düşük faiz ve hızlı büyüme",
      "Ticaret fazlası ve düşük enflasyon"
    ],
    "answer": 0
  },
  {
  ...
  {
    "q": "Hukukta 'içtihat' kavramı en doğru şekilde neyi ifade eder?",
    "options": [
      "Yasama organının çıkardığı kanun",
      "Yargı kararlarıyla oluşan hukuki yorum ve uygulama",
  ...
  {
    "q": "'WWW' kısaltması internette neyin baş harfleridir?",
    "options": [
      "World Wide Web",
      "Wireless Web World",
      "World Web Window",
